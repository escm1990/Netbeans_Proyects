 ...
 * client.java
 *
 * Created on 20-mar-2011, 21:39:56
 */
package cliente;
...
public class client extends javax.swing.JFrame {
    ...
    public String mensaje = "", ip_servidor = null, nickname = "";
    byte[] arrayData;
    public String ruta;
    ...
    public void setIP() {
        ip_servidor = JOptionPane.showInputDialog(rootPane, "Ingrese la IP del Servidor.");
        if (ip_servidor.isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "No se ingresó ninguna IP.\nLa aplicación terminará.");
            cerrarConexion();
        }
    }
    ...
    public void conectaraSevidor() throws IOException {
        ...
        cliente = new Socket(ip_servidor, 1234);
    ...
    private void recibirArchivo() {
        ...
        try {
            ...
            while (true) {
                ...
                String cadena = null;
                StringTokenizer roota = new StringTokenizer(chooserObj.getCurrentDirectory().getPath(), "\\");
                while (roota.hasMoreTokens()) {
                    cadena += roota.nextToken() + "/";
                }
    ...
    private void initComponents() {
        ...
        setTitle("CHAT HDP 2011 - Cliente");
        setMinimumSize(new java.awt.Dimension(392, 389));
        setResizable(false);
        ...
        jpBackground.setPreferredSize(new java.awt.Dimension(409, 392));
            ...
            .addGroup(jpBackgroundLayout.createSequentialGroup()
                ...
                .addGroup(jpBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jpBackgroundLayout.createSequentialGroup()
                        ...
                        .addComponent(txt_mns, javax.swing.GroupLayout.DEFAULT_SIZE, 232, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jpBackground, javax.swing.GroupLayout.PREFERRED_SIZE, 372, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
