...
%>	  
  <tr>
    ...
    <td align="center" class="td"><a href="imprimir_estado.jsp?id=<% out.println(datos.getInt("id_estado"));  %>" target="_blank"><img src="css/arrow_out.png" width="16" height="16" border="0" /></a></td>
