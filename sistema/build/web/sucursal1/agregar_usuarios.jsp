...
try{
    ...
    if(con!=null){
        ...
        ResultSet datos = comando.executeQuery("select * from usuarios1 where usuario='"+usu+"'");
        if(datos.next()==true){
         ...
         int a = 0;   
        a = comando.executeUpdate("insert into usuarios1(usuario,clave) values ('"+usu+"','"+cla+"')");
        if(a>=1){
