...
<div id="menu">
 ...
 if(session.getAttribute("admin")!=null){
  ...
  <ul>
	...
	<li><a href="index.jsp?pag=estadisticas1.jsp" title="">Sucursal 1</a></li>
	<li><a href="index.jsp?pag=estadisticas2.jsp" title="">Sucursal 2</a></li>
	<li><a href="index.jsp?pag=estadisticas3.jsp" title="">Sucursal 3</a></li>
	<li><a href="index.jsp?pag=estadisticas4.jsp" title="">Sucursal 4</a></li>
    <li><a href="index.jsp?pag=chat.jsp" title="">Chat</a></li>
