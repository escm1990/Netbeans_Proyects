...
try{
    ...
    if(con!=null){
        ...
        if(a>=1){ %>
           <script>alert('Registro Eliminado');location.href='index.jsp?pag=estados4.jsp';</script>
      <%  }else{ %>
            <script>alert('Error al Eliminar');location.href='index.jsp?pag=estados4.jsp';</script>
       <% }
        }
