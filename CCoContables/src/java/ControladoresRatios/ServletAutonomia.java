 ...
 * @author Chavez Vigil
 */
public class ServletAutonomia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            double Autonomia = R_Aplacamiento.autonomia(patrimonio, totalActivo);
            Autonomia = Autonomia* 100;
            Autonomia = Math.rint(Autonomia);
            Autonomia = Autonomia / 100;
            out.println("<html><body><h3>Razon de Autonomia</h3><p>Autonomia de la Empresa : " + Autonomia + "</p></body></html>");
