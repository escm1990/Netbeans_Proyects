...
//Importando la clase itextpdf, para manipulacion de archivos PDF
...
public class Java_PDF {
    ...
    public void crearPDF(String t, String a, String s, String k, String c) throws FileNotFoundException{
        ...
        if(this.ruta_destino!=null){
            try{
                ...
                miPDF.addTitle(t);//Se añade el Titulo del Documento
                ...
                miPDF.add(new Paragraph(c));//Se añade el contenido del Documento
