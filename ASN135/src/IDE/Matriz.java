...
public class Matriz {
    ...
    public void setValor(int fila, int columna, String fraccion) {
    ...
    public static Matriz sumar(Matriz a, Matriz b) throws MatrizNoOperableException {
        try {
            Matriz resultado = new Matriz(a.getNumeroFilas(), a.getNumeroColumnas());
            if (a.getNumeroFilas() == b.getNumeroColumnas() && a.getNumeroColumnas() == b.getNumeroFilas()) {
    ...
    public static Matriz multiplicar(Matriz a, Matriz b) throws MatrizNoOperableException {
        Matriz res = null;
        if (a.getNumeroColumnas() == b.getNumeroFilas()) {
            int filasA = a.getNumeroFilas();
            int columnasA = a.getNumeroColumnas();
            int columnasB = b.getNumeroColumnas();
    ...
    public static Matriz transponer(Matriz a) throws MatrizNoOperableException {
        int filasT = a.getNumeroFilas();
        int columnasT = a.getNumeroColumnas();
        if (filasT == a.getNumeroFilas() && columnasT == a.getNumeroColumnas()) {
    ...
    @Override
    public Matriz clone() {
        Matriz res = new Matriz(this.getNumeroFilas(), this.getNumeroColumnas());
        for (int i = 0; i < res.getNumeroFilas(); i++) {
            for (int k = 0; k < res.getNumeroColumnas(); k++) {
    ...
    public static Matriz obtenerIdentidad(Matriz a) throws MatrizNoOperableException {
        Matriz res = new Matriz(a.getNumeroFilas(), a.getNumeroColumnas());
        if (a.getNumeroColumnas() == a.getNumeroFilas()) {
            for (int i = 0; i < a.getNumeroColumnas(); i++) {
                res.setValor(i, i, 1);
            }
        } else {
            throw new MatrizNoOperableException("Error al operar la matriz");
